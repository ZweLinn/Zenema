...
import PopularMovieResult from "@/type/movies/popular/popularResult";
import { ImgPath } from "@/util/imgPath";
import Image from "next/image";
import { useRouter } from "next/navigation";

export default function PopularMovieLists({ popular }: { popular: Popular}) {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 text-center m-auto max-w-7xl">
            {
                popular?.results.map((movie: PopularMovieResult) => (
